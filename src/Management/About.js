            ...
            <div className='row'>
                ...
                <div className='col-lg-6'>
                    ...
                    <p>
                        ...
                        We envision a future where every student who walks into CampusNexa walks out as a confident, capable, and compassionate individual ready to lead, innovate, and make a difference.
                    </p>
                </div>
                <div className='col-lg-6 text-center'>
                    <h2>Our Mission</h2>
                    <p>
                        At CampusNexa, our mission is to provide quality, affordable, and value-driven education that nurtures academic excellence, personal growth, and professional readiness. We strive to create a supportive and disciplined learning environment where students are encouraged to think critically, act ethically, and pursue their goals with confidence. Through experienced faculty, practical training, and continuous mentorship, we aim to empower every student with the knowledge, skills, and values needed to succeed in today’s competitive world.
                    </p>
                </div>
                <div className='col-lg-6 p-3 text-end '>
